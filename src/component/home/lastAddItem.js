  ...
  const items = [
    {
      ...
      description: "Become a Farmer for a small farm in maiami and stay for free. Experience free city tours.",
      duration: "6 Months",
      country: "USA",
    },
    {
            ...
            <Grid key={item} item xs={12} sm={4} md={3}>
              <Card style = {{overflowY: "auto"}} className={classes.Card} >
                <CardActionArea  >
                  ...
                  <Typography  className={classes.CardFont} variant="subtitle1" color="textSecondary">
                    {item.profileName}
                </Typography>
                ...
                <Grid container style={{ backgroundColor: "#ffb400", height: 1, marginTop: 10 }} item xs={12} sm={12} md={12}></Grid>
