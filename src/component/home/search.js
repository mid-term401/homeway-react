...
export default function CountrySelect() {
  ...
  return (
    <Container>
      <Grid className='mainContainer' xs={9} sm={9} md={8}>
        <Grid>
          <Typography className='titleIntro' gutterBottom variant='h3' component='h3'>
        ...
        <form onSubmit={SubmitSignInForm}>
          <Grid className='searchBar' container spacing={2}>
            ...
            <Grid item xs={12} sm={12} md={4}>
              <Button type='submit' variant='contained' color='primary' className='searchBtn'>
                Search
              </Button>
            </Grid>
          </Grid>
